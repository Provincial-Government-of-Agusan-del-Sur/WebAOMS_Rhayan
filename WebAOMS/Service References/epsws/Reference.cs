...
namespace WebAOMS.epsws {
    ...
    public interface serviceSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        WebAOMS.epsws.GetUpdatesResponse GetUpdates(WebAOMS.epsws.GetUpdatesRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/GetUpdates", ReplyAction="*")]
        System.Threading.Tasks.Task<WebAOMS.epsws.GetUpdatesResponse> GetUpdatesAsync(WebAOMS.epsws.GetUpdatesRequest request);
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string AddAttendance(string swipeid, int iscompany);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/AddAttendance", ReplyAction="*")]
        System.Threading.Tasks.Task<string> AddAttendanceAsync(string swipeid, int iscompany);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface serviceSoapChannel : WebAOMS.epsws.serviceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class serviceSoapClient : System.ServiceModel.ClientBase<WebAOMS.epsws.serviceSoap>, WebAOMS.epsws.serviceSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        WebAOMS.epsws.GetUpdatesResponse WebAOMS.epsws.serviceSoap.GetUpdates(WebAOMS.epsws.GetUpdatesRequest request) {
            return base.Channel.GetUpdates(request);
        }
        
        public void GetUpdates(string fileName, string contentType, byte[] bytes) {
            WebAOMS.epsws.GetUpdatesRequest inValue = new WebAOMS.epsws.GetUpdatesRequest();
            inValue.fileName = fileName;
            inValue.contentType = contentType;
            inValue.bytes = bytes;
            WebAOMS.epsws.GetUpdatesResponse retVal = ((WebAOMS.epsws.serviceSoap)(this)).GetUpdates(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<WebAOMS.epsws.GetUpdatesResponse> WebAOMS.epsws.serviceSoap.GetUpdatesAsync(WebAOMS.epsws.GetUpdatesRequest request) {
            return base.Channel.GetUpdatesAsync(request);
        }
        
        public System.Threading.Tasks.Task<WebAOMS.epsws.GetUpdatesResponse> GetUpdatesAsync(string fileName, string contentType, byte[] bytes) {
            WebAOMS.epsws.GetUpdatesRequest inValue = new WebAOMS.epsws.GetUpdatesRequest();
            inValue.fileName = fileName;
            inValue.contentType = contentType;
            inValue.bytes = bytes;
            return ((WebAOMS.epsws.serviceSoap)(this)).GetUpdatesAsync(inValue);
        }
        ...
        public string AddAttendance(string swipeid, int iscompany) {
            return base.Channel.AddAttendance(swipeid, iscompany);
        }
        
        public System.Threading.Tasks.Task<string> AddAttendanceAsync(string swipeid, int iscompany) {
            return base.Channel.AddAttendanceAsync(swipeid, iscompany);
        }
    }
}
