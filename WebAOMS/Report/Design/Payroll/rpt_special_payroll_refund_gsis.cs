namespace IFMIS.Report.Design.Payroll
{
    ...
    /// <summary>
    /// Summary description for rpt_special_payroll_refund_gsis.
    /// </summary>
    public partial class rpt_special_payroll_refund_gsis : Telerik.Reporting.Report
    {
        public rpt_special_payroll_refund_gsis(int batchno, int bankid, int officeid)
        {
            //
            ...
            this.table1.DataSource = ISfn.ExecuteDataset("exec [epay].usp_print_special_payroll_dynamic " + batchno + "," + bankid + "," + USER.C_eID.ToString());
