namespace IFMIS.Report.Design.Payroll
{
    ...
    /// <summary>
    /// Summary description for rpt_remiitance_Pagibig.
    /// </summary>
    public partial class rpt_remiitance_Pagibig : Telerik.Reporting.Report
    {
        public rpt_remiitance_Pagibig(int year, int month, string officeArray, int deductionID, int remittanceType)
        {
            //
