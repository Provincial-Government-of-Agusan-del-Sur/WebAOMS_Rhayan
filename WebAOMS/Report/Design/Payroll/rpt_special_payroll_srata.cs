namespace IFMIS.Report.Design.Payroll
{
    ...
    /// <summary>
    /// Summary description for rpt_special_payroll_srata.
    /// </summary>
    public partial class rpt_special_payroll_srata : Telerik.Reporting.Report
    {
        public rpt_special_payroll_srata(int bonusbatchno, int userid, int OfficeID)
        {
            //
