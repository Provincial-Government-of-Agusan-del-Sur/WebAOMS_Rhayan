namespace IFMIS.Report.Design.Payroll
{
    ...
    /// <summary>
    /// Summary description for rpt_special_payroll_refund_coop.
    /// </summary>
    public partial class rpt_special_payroll_refund_coop : Telerik.Reporting.Report
    {
        public rpt_special_payroll_refund_coop(int batchno, int bankid, int officeid)
        {
            //
