namespace IFMIS.Report.Design.Payroll
{
    ...
    /// </summary>
    public partial class rpt_Payroll_Contract : Telerik.Reporting.Report
    {
        public rpt_Payroll_Contract(int batchno,int officeID,int year,int month,int qtr,int emptyp = 6)
        {
            //
