namespace IFMIS.Report.Design.Payroll
{
    ...
    /// <summary>
    /// Summary description for rpt_remittance_Philhealth.
    /// </summary>
    public partial class rpt_remittance_Philhealth : Telerik.Reporting.Report
    {
        public rpt_remittance_Philhealth(int year, int month, string officeArray, int deductionID, int remittanceType)
        {
