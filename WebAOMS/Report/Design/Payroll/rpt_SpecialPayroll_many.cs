namespace IFMIS.Report.Design.Payroll
{
    ...
    /// <summary>
    /// Summary description for rpt_SpecialPayroll_many.
    /// </summary>
    public partial class rpt_SpecialPayroll_many : Telerik.Reporting.Report
    {
        public rpt_SpecialPayroll_many(int year, int month, int bonusbatchno, int userid, int OfficeID)
        {
            //
            ...
            textBox2.Value = "YEAR END BONUS " + year.ToString() + "(" + emptype + ")";
