namespace IFMIS.Report.Design.Payroll
{
    ...
    /// <summary>
    /// Summary description for rpt_special_payroll_EME.
    /// </summary>
    public partial class rpt_special_payroll_EME : Telerik.Reporting.Report
    {
        public rpt_special_payroll_EME(int bonusbatchno, int userid, int OfficeID)
        {
            //
