namespace IFMIS.Report.Design.Payroll
{
    ...
    /// <summary>
    /// Summary description for rpt_Certification_Deductions.
    /// </summary>
    public partial class rpt_Certification_Deductions : Telerik.Reporting.Report
    {
        public rpt_Certification_Deductions(int eid, int from, int to, int payreffid)
        {
            //
