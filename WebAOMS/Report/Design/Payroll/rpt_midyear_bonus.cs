namespace IFMIS.Report.Design.Payroll
{
    ...
    /// <summary>
    /// Summary description for rpt_midyear_bonus.
    /// </summary>
    public partial class rpt_midyear_bonus : Telerik.Reporting.Report
    {
        public rpt_midyear_bonus(int bonusbatchno, int officeid, int year)
        {
            //
            ...
            textBox2.Value = "MID-YEAR BONUS " + DateTime.Now.Year.ToString() + "(" + emptype + ")";
            ...
            rec = OleDbHelper.ExecuteDataset(ConfigurationManager.ConnectionStrings["pmisDBconnstring"].ToString(), CommandType.Text, "EXECUTE [epay].[usp_rpt_midyear_bonus] "+bonusbatchno+","+USER.C_eID+","+officeid+"");
