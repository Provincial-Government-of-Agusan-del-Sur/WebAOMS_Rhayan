namespace WebAOMS.Report.Design
{
    ...
    /// <summary>
    /// Summary description for rpt_Journal_CheckD.
    /// </summary>
    public partial class rpt_Journal_CheckD : Telerik.Reporting.Report
    {
        public rpt_Journal_CheckD(Int16 fundid, DateTime to)
        {
            ...
            refno = "02" + reportid.ToString("000") + fundid.ToString("000") + to.ToString("MMddyyyy");
