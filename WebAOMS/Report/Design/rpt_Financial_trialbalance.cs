namespace WebAOMS.Report.Design
{
    ...
    /// <summary>
    /// Summary description for rpt_Financial_trialbalance.
    /// </summary>
    public partial class Trial_Balance : Telerik.Reporting.Report
    {
        string fmisConn = ConfigurationManager.ConnectionStrings["DefaultConnection"].ToString();
        public Trial_Balance(Int16 fundid, int IsPreClosing, DateTime to)
        {
            InitializeComponent();
