namespace WebAOMS.Report.Design
{
    ...
    /// <summary>
    /// Summary description for rpt_Financial_performance.
    /// </summary>
    public partial class Financial_Performance : Telerik.Reporting.Report
    {
        string fmisConn = ConfigurationManager.ConnectionStrings["DefaultConnection"].ToString();
        public Financial_Performance(Int16 fundid, int IsDatailed, DateTime to)
        {
            //
