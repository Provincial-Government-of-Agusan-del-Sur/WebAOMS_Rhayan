namespace WebAOMS.Report.Design
{
    ...
    /// <summary>
    /// Summary description for rpt_Financial_position.
    /// </summary>
    public partial class Financial_Position : Telerik.Reporting.Report
    {
        string fmisConn = ConfigurationManager.ConnectionStrings["DefaultConnection"].ToString();
        public Financial_Position(Int16 fundid, int IsDatailed, DateTime to)
        {
            //
            ...
            else
            {
                ...
                string cmdStr = "exec [Accounting].[usp_rpt_Financial_Position] @userid ,@fundid ,@to ,@IsDetailed";
