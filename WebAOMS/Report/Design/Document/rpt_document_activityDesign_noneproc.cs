namespace WebAOMS.Report.Design.Document
{
    ...
    /// <summary>
    /// Summary description for rpt_document_activityDesign_noneproc.
    /// </summary>
    public partial class rpt_document_activityDesign_noneproc : Telerik.Reporting.Report
    {
        public rpt_document_activityDesign_noneproc(int report_id, long doc_details_id)
        {
            ...
            string refno = "";
            string cmdStr = "execute [Accounting].[usp_rpt_Doc_details_test_v2] @report_id, @doc_details_id,@userid";
            ...
            using (SqlCommand command = new SqlCommand(cmdStr, connection))
            {
                ...
                if (reader.HasRows == true)
                {
                    while (reader.Read())
                    {
                        ...
                        txt_expected_output.Value = HttpUtility.HtmlDecode(reader["ExpectedOutput"].ToString()).Replace("&nbsp;&nbsp;", "");
                        txt_methodology.Value = HttpUtility.HtmlDecode(reader["Methodology"].ToString()).Replace("&nbsp;&nbsp;", "");
            ...
            string cmdtbl = "exec [Accounting].[usp_rpt_Doc_Event] @eventID";
            ...
            if (report_id == 49 || report_id == 54)
            {
                tbl_ips.Visible = true;
                textBox39.Visible = true;
                textBox36.Visible = true;
                txt_methodology.Visible = true;
            }
