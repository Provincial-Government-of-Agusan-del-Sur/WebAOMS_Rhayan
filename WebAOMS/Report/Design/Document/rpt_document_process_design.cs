namespace WebAOMS.Report.Design.Document
{
    ...
    /// <summary>
    /// Summary description for rpt_document_process_design.
    /// </summary>
    public partial class rpt_document_process_design : Telerik.Reporting.Report
    {
        public rpt_document_process_design(int report_id, long doc_details_id)
        {
            //
            ...
            tbl_ips.DataSource = dt.Tables[0];//IPS
            tbl_targetpar.DataSource = dt.Tables[1];
