namespace WebAOMS.Report.Design
{
    ...
    /// <summary>
    /// Summary description for rpt_query_SCBAA.
    /// </summary>
    public partial class rpt_query_SCBAA : Telerik.Reporting.Report
    {
        string fmisConn = ConfigurationManager.ConnectionStrings["DefaultConnection"].ToString();
        public rpt_query_SCBAA(Int16 fundid, DateTime to)
        {
            //
            ...
            else
            {
                ...
                string cmdStr = "exec [Accounting].[usp_rpt_Query_SCBAA] @userid ,@fundid ,@to";
