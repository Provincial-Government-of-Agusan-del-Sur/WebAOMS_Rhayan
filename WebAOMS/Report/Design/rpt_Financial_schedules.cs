namespace WebAOMS.Report.Design
{
    ...
    /// <summary>
    /// Summary description for rpt_Financial_schedules.
    /// </summary>
    public partial class rpt_Financial_schedules : Telerik.Reporting.Report
    {
        ...
        public rpt_Financial_schedules(Int16 fundid, DateTime to)
        {
            ...
            else
            {
                ...
                string cmdStr = "exec [Accounting].[usp_rpt_Financial_Schedules_test1] @userid ,@fundid ,@to";
