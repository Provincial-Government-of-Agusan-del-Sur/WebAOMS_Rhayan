namespace WebAOMS.Report.Design
{
    ...
    /// <summary>
    /// Summary description for rpt_Journal_CashReceips.
    /// </summary>
    public partial class rpt_Journal_CashReceips : Telerik.Reporting.Report
    {
        string fmisConn = ConfigurationManager.ConnectionStrings["DefaultConnection"].ToString();
        public rpt_Journal_CashReceips(Int16 fundid, DateTime to)
        {
            //
            ...
            refno = "01" + reportid.ToString("000") + fundid.ToString("000") + to.ToString("MMddyyyy");
