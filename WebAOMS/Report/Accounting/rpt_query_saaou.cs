namespace WebAOMS.Report.Accounting
{
    using System;
    using System.Data;
    using WebAOMS.Base;
    ...
    /// <summary>
    /// Summary description for rpt_query_saaou.
    /// </summary>
    public partial class rpt_query_saaou : Telerik.Reporting.Report
    {
        string fmisConn = ConfigurationManager.ConnectionStrings["DefaultConnection"].ToString();
        public rpt_query_saaou(Int16 fundid, DateTime to, int hideAccountname, int hideOOEname,int reportid)
        {
            //
